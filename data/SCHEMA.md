...
```
{
  ...
  fichaModels:   [ "residential", "commercial-hospitality",
                   "land-development", "confidential-teaser" ],
...
## Ficha (listing) models (`model`, §5 — 4 + 1 future)
...
5. *(future)* `commodities-productive` — mining/quarry/agro/operating productive assets (Phase 4).
