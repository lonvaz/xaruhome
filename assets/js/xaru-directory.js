...
(function () {
  ...
  var T = {
    ...
    demoNote:    {en:"Sample profile. Particulars are illustrative until the live record is loaded.",
                  es:"Perfil de muestra. Los datos son ilustrativos hasta que se cargue el registro real.",
                  ar:"ملف تجريبي. البيانات إيضاحية إلى أن يُحمَّل السجل الفعلي.",
                  zh:"样例主页。在正式记录载入前，各项数据仅供示意。"},
