...
(function () {
  ...
  var T = {
    ...
    demoNote:   {en:"Platform demonstration project — the structure, the payment-plan model and the workflow are the production ones; the project is not.",
                 es:"Proyecto de demostración de la plataforma — la estructura, el modelo de plan de pago y el flujo son los de producción; el proyecto no.",
                 ar:"مشروع تجريبي للمنصة — البنية ونموذج خطة السداد وسير العمل هي الإنتاجية، أما المشروع فلا.",
                 zh:"平台演示项目——架构、付款计划模型与流程均为正式环境，项目本身则非真实。"},
